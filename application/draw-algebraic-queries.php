    ...
    <div id="main">
        <div id="forms">
            <ul class="list-group">
                ...
                <button id="joinObject" class="list-group-item list-group-item-action" data-toggle="tooltip"
                ...
                <button id="subQueryObject" class="list-group-item list-group-item-action" data-toggle="tooltip"
                        data-placement="right" title="SOUS REQUÊTE">
                    <svg height="80" width="100">
                        <path id="polySubQuery" d="M20 40L35 33L35 10L80 10L80 70L35 70L35 48z" fill="#FFFFFF"
                              stroke="#000" stroke-width="2"></path>
                    </svg>
                </button>
                <button id="groupByObject" class="list-group-item list-group-item-action" data-toggle="tooltip"
                        data-placement="right" title="GROUP BY">GROUP BY
                </button>
                <button id="havingObject" class="list-group-item list-group-item-action" data-toggle="tooltip"
                        data-placement="right" title="HAVING">HAVNG
                </button>
                <button id="orderByObject" class="list-group-item list-group-item-action" data-toggle="tooltip"
                        data-placement="right" title="ORDER BY">ORDER BY
                </button>
        ...
        <div id="options">
            <ul class="list-group list-group-horizontal">
                <button id="clone" class="list-group-item list-group-item-action" data-toggle="tooltip"
                        data-placement="left" title="Cloner un objet"><i class="fas fa-clone"></i></button>
                <button id="delete" class="list-group-item list-group-item-action" data-toggle="tooltip"
                        data-placement="left" title="Supprimer un objet"><i class="fas fa-trash-alt"></i></button>
                <button id="zoomIn" class="list-group-item list-group-item-action" data-toggle="tooltip"
